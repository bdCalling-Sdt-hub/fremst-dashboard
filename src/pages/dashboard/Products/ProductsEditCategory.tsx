  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between w-[672px] mb-5">
        ...
        <button onClick={() => setOpen(true)} className="bg-primary text-white px-3 h-[40px] rounded  transition flex items-center justify-center gap-1">
          <span> <FiPlus size={18} /> </span> <span> {t("addCategory")}  </span>
        </button>
      </div>
